...
type ClickHouse struct {
	...
	Tag1CountTable       string                `toml:"tag1-count-table"         json:"tag1-count-table"         comment:"table that contains the amounts of rows with each tag1 value, used to determine which Tag1 value to use in a query based on its cardinality"`
