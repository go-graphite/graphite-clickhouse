...
func (it *emptyIterator) AtHistogram() (int64, *histogram.Histogram) { return 0, nil }
...
func (it *emptyIterator) AtFloatHistogram() (int64, *histogram.FloatHistogram) { return 0, nil }
