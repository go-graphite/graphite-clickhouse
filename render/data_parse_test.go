...
func TestDataParse(t *testing.T) {
	...
	t.Run("ok", func(t *testing.T) {
		table := [][]point.Point{
			{
				{"hello.world", 1520056686, 42.1, 1520056706, 1},
				{"foobar", 1520056687, 42.2, 1520056707, 2},
			},
			{
				{"samelen1", 1520056686, 42.1, 1520056706, 1},
				{"samelen2", 1520056687, 42.2, 1520056707, 2},
			},
			{
				{"key1", 1520056686, 42.1, 1520056706, 1},
				{"key2", 1520056687, 42.2, 1520056707, 2},
				{"key1", 1520056687, 42.2, 1520056707, 1},
			},
		}
